    ...
    while (running) {
        ...
        if (++perf_presents == 60) {
            ...
            if (perf_log && perf_rows++ < 600) {
                ...
                append_frame_log(perf_log, "%s,%d,%u,%u,%u,%.3f,%.3f,%.3f,%.3f,%.3f,%.3f,%06X,%.3f,%.3f,%u,%u,%u,%.3f,%.3f,%.3f,%u,%u,%u,%.3f,%u,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu\n",
                        ...
                        (unsigned long long)(perf_cpu_now.hot_plain_memory_2b_instructions - perf_cpu_start.hot_plain_memory_2b_instructions),
                        (unsigned long long)(perf_cpu_now.hot_plain_memory_4b_instructions - perf_cpu_start.hot_plain_memory_4b_instructions),
                        (unsigned long long)(perf_cpu_now.hot_prefix0100_plain_memory_instructions - perf_cpu_start.hot_prefix0100_plain_memory_instructions),
                        (unsigned long long)(perf_cpu_now.hot_branch8_instructions - perf_cpu_start.hot_branch8_instructions),
                        (unsigned long long)(perf_cpu_now.hot_register_bit_instructions - perf_cpu_start.hot_register_bit_instructions));
